    ...
    pub fn new(state: &mut VulkanState, texture_manager: &mut TextureManager) -> Result<Box<Self>> {
        ...
        let (pipeline_layout_mlp, pipeline_mlp) = {
            utils::create_graphics_pipeline(
                ...
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/mlp.vert.spv"
                )),
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/mlp.frag.spv"
                )),
        ...
        let (pipeline_layout_analytic, pipeline_analytic) = {
            utils::create_graphics_pipeline(
                ...
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/analytic.vert.spv"
                )),
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/analytic.frag.spv"
                )),
                &[vk::PushConstantRange {
                    stage_flags: vk::ShaderStageFlags::VERTEX | vk::ShaderStageFlags::FRAGMENT,
                    offset: 0,
        ...
        let (pipeline_layout_diff, pipeline_diff) = {
            utils::create_graphics_pipeline(
                ...
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/diff.vert.spv"
                )),
                include_bytes!(concat!(
                    env!("OUT_DIR"),
                    "/shaders/scene/disney_rtnam/diff.frag.spv"
                )),
                &[vk::PushConstantRange {
                    stage_flags: vk::ShaderStageFlags::VERTEX | vk::ShaderStageFlags::FRAGMENT,
                    offset: 0,
        ...
        let network = Network::from_json(
            ...
            "./network/disney-rtnam/decoder.json",
        )?;
...
impl Scene for DisneyRtnamScene {
    fn scene_name(&self) -> &'static str {
        "Disney Real-Time Neural Appearance Model"
    }
    ...
    fn cmd_draw(
        ...
        let uniform_buffer = UniformBuffer {
            ...
            latent_texture_0: self.latent_texture_0,
            latent_texture_1: self.latent_texture_1,
