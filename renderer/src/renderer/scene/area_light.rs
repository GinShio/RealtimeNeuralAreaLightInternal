...
struct ModelPushConstants {
    ...
    weight_offsets_2: [u32; 4],
    bias_offsets_0: [u32; 4],
    bias_offsets_1: [u32; 4],
    bias_offsets_2: [u32; 4],
    ...
    fn cmd_draw(
        ...
        for (model, model_matrix) in models {
            ...
            let push_constants = ModelPushConstants {
                ...
                weight_offsets_2: [
                    model.network_weight_offsets[8],
                    model.network_weight_offsets[9],
                    model.network_weight_offsets[10],
                    model.network_weight_offsets[11],
                ],
                bias_offsets_0: [
                ...
                bias_offsets_2: [
                    model.network_bias_offsets[8],
                    model.network_bias_offsets[9],
                    model.network_bias_offsets[10],
                    model.network_bias_offsets[11],
                ],
